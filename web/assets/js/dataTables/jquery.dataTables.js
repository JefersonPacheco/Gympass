...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( oLanguage )
	{
		...
		if ( !oLanguage.sEmptyTable && zeroRecords &&
			oDefaults.sEmptyTable === "Sem dados na tabela" )
		{
	...
	DataTable.defaults = {
		 ...
		 *    } )
		 */
                // Este é o comando para alterar o valor inicial da paginação
		"iDisplayLength": 50,
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "Mostrando _END_ resultados",
			 ...
			 *    } );
			 */
			"sZeroRecords": "Sem registros encontrados para esta pesquisa!"
		},
